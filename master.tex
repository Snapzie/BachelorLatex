...
\HRule \\[0.4cm]
{ \huge \bfseries Synthesis of Actor Code and Tests}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\include{Sections/ActorModel/ActorModel}
\include{Sections/CLS/CLS}
\include{Sections/AdventureGame/AdventureGame}
\include{Sections/Decomposition/Decomposition}
\include{Sections/TestingTheory/TestingTheory}
\include{Sections/TestingDiscussion/TestingDiscussion}
